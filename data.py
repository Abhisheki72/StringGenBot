...
class Data:
    ...
    buttons = [
        ...
        [InlineKeyboardButton("❣️ sᴜᴩᴩᴏʀᴛ ❣️", url="https://t.me/TrickyAbhiTeam"),
         InlineKeyboardButton("🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", url="https://t.me/Am_ABHISH3K"),
        ],
    ]
...
Mᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ : [[🇮🇳]【﻿अभिषेक】»](https://t.me/Am_ABHISH3K) !
    """
